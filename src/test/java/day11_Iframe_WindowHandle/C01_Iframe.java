...
public class C01_Iframe extends TestBase {
    ...
    */
    ...
    public void iframe() {
        ...
        Assert.assertTrue(titleElement.getText().contains("Editor"));
        bekle(2);
        ...
        //driver.navigate().refresh(); //Sayfayi yeniler ve basa doner. -->Bu methodla sayfayı yenilediğimiz için ilk bölüme tekrar geçmiş oluruz
        bekle(2);
