...
//        3-Sayfadaki cookies sayisinin 5’ten buyuk oldugunu test edin
        ...
        System.out.println("allCookieSize = " + allCookieSize);
...
//        7-ismi skin olan cookie’yi silin ve silindigini test edin
        int cookieBeforeDeletion = driver.manage().getCookies().size();
        driver.manage().deleteCookieNamed("skin");
        int cookieAfterDeletion = driver.manage().getCookies().size();
        assertEquals(1, (cookieBeforeDeletion - cookieAfterDeletion));
