...
public class C04_StaleElementException extends TestBase {
    ...
    public void staleElementExceptionTest3() {
        ...
        driver.navigate().back();//techproeducation.com sayfasına geri döndük ==> Sayfa yeniden yüklendiği için locator adresi silindi.
        lmsLogin.click();//org.openqa.selenium.StaleElementReferenceException
    }
    ...
    public void staleElementExceptionTest4() {
        ...
        //Tekrar locate işlemi yaparak lmsLogin objesine yeni adres veriliyor.
        lmsLogin.click();//Çalıştı
    }
    ...
    public void staleElementExceptionTest5() {
        ...
        driver.get("https://www.techproeducation.com");//LMS'e gittikten sonra techproeducation sayfasına geri dönerek sayfayı yenilemiş oluyoruz.
